...
from confirming_django_tenants.tenants.models import User, Tenant
from confirming_django_tenants.rbac.services import RBACService, PermissionSeeder
from confirming_django_tenants.authentication.models import (
...
class AuthenticationService:
    ...
    def initiate_registration(
        *,
        ...
        """
        Step 1: Initiate registration by creating user and sending verification email.
        
        The tenant is NOT created yet. It will be created after email verification.
        ...
        with transaction.atomic():
            ...
            user = User.objects.create_user(
                ...
                password=password,
                is_verified=False,
                is_active=False,  # Cannot login until verified
            )
            
            # Store tenant registration data temporarily
            # We'll use the user's profile or a cache for this
