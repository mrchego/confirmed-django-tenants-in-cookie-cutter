...
from confirming_django_tenants.rbac.graphql.types import RoleType, UserRoleType
...
class RBACMutation:
    ...
    def assign_role(
        ...
        from confirming_django_tenants.tenants.models import User
    ...
    def remove_role(
        ...
        from confirming_django_tenants.rbac.models import UserRole
