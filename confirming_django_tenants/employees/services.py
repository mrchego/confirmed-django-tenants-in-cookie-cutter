...
from confirming_django_tenants.employees.models import Employee, Department
...
from confirming_django_tenants.employees.graphql.types import DepartmentType, EmployeeType
        ...
        with schema_context(tenant.schema_name):
            with transaction.atomic():
                ...
                if allow_login and email and password:
                    ...
                    if role_id:
                        from confirming_django_tenants.rbac.models import Role
